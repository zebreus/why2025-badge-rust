...
RAW_BINDINGS_DIR="$SCRIPT_DIR/src"
WRAPPER_LINKER_TEST="$ROOT_DIR/why2025-badge-sys/src/linker_test.rs"
...
function emit_linker_function_assertion() {
    ...
    echo "            assert_ne!($normalized_symbol as *const (), core::ptr::null());" >> "$WRAPPER_LINKER_TEST"
}
...
function emit_linker_var_assertion() {
    ...
    echo "            assert_ne!(core::ptr::addr_of!($normalized_symbol) as *const (), core::ptr::null());" >> "$WRAPPER_LINKER_TEST"
}
