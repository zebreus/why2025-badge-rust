...
const _: () = {
    ["Size of option"][::core::mem::size_of::<option>() - 32usize];
    ["Alignment of option"][::core::mem::align_of::<option>() - 8usize];
    ["Offset of field: option::name"][::core::mem::offset_of!(option, name) - 0usize];
    ["Offset of field: option::has_arg"][::core::mem::offset_of!(option, has_arg) - 8usize];
    ["Offset of field: option::flag"][::core::mem::offset_of!(option, flag) - 16usize];
    ["Offset of field: option::val"][::core::mem::offset_of!(option, val) - 24usize];
};
unsafe extern "C" {
    pub fn getopt(
...
const _: () = {
    ...
    ["Offset of field: lconv::frac_digits"][::core::mem::offset_of!(lconv, frac_digits) - 81usize];
    ...
    ["Offset of field: lconv::p_sign_posn"][::core::mem::offset_of!(lconv, p_sign_posn) - 86usize];
    ["Offset of field: lconv::n_sign_posn"][::core::mem::offset_of!(lconv, n_sign_posn) - 87usize];
    ["Offset of field: lconv::int_n_cs_precedes"]
        [::core::mem::offset_of!(lconv, int_n_cs_precedes) - 88usize];
    ["Offset of field: lconv::int_n_sep_by_space"]
        [::core::mem::offset_of!(lconv, int_n_sep_by_space) - 89usize];
    ["Offset of field: lconv::int_n_sign_posn"]
        [::core::mem::offset_of!(lconv, int_n_sign_posn) - 90usize];
    ["Offset of field: lconv::int_p_cs_precedes"]
        [::core::mem::offset_of!(lconv, int_p_cs_precedes) - 91usize];
    ["Offset of field: lconv::int_p_sep_by_space"]
        [::core::mem::offset_of!(lconv, int_p_sep_by_space) - 92usize];
    ["Offset of field: lconv::int_p_sign_posn"]
        [::core::mem::offset_of!(lconv, int_p_sign_posn) - 93usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of regex_t"][::core::mem::size_of::<regex_t>() - 32usize];
    ["Alignment of regex_t"][::core::mem::align_of::<regex_t>() - 8usize];
    ["Offset of field: regex_t::re_magic"][::core::mem::offset_of!(regex_t, re_magic) - 0usize];
    ["Offset of field: regex_t::re_nsub"][::core::mem::offset_of!(regex_t, re_nsub) - 8usize];
    ["Offset of field: regex_t::re_endp"][::core::mem::offset_of!(regex_t, re_endp) - 16usize];
    ["Offset of field: regex_t::re_g"][::core::mem::offset_of!(regex_t, re_g) - 24usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of regmatch_t"][::core::mem::size_of::<regmatch_t>() - 16usize];
    ["Alignment of regmatch_t"][::core::mem::align_of::<regmatch_t>() - 8usize];
    ["Offset of field: regmatch_t::rm_so"][::core::mem::offset_of!(regmatch_t, rm_so) - 0usize];
    ["Offset of field: regmatch_t::rm_eo"][::core::mem::offset_of!(regmatch_t, rm_eo) - 8usize];
};
unsafe extern "C" {
    pub fn regcomp(
        arg1: *mut regex_t,
...
pub type __ungetc_t = __uint16_t;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct __file {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of __file"][::core::mem::size_of::<__file>() - 32usize];
    ["Alignment of __file"][::core::mem::align_of::<__file>() - 8usize];
    ["Offset of field: __file::unget"][::core::mem::offset_of!(__file, unget) - 0usize];
    ["Offset of field: __file::flags"][::core::mem::offset_of!(__file, flags) - 2usize];
    ["Offset of field: __file::put"][::core::mem::offset_of!(__file, put) - 8usize];
    ["Offset of field: __file::get"][::core::mem::offset_of!(__file, get) - 16usize];
    ["Offset of field: __file::flush"][::core::mem::offset_of!(__file, flush) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of tms"][::core::mem::size_of::<tms>() - 32usize];
    ["Alignment of tms"][::core::mem::align_of::<tms>() - 8usize];
    ["Offset of field: tms::tms_utime"][::core::mem::offset_of!(tms, tms_utime) - 0usize];
    ["Offset of field: tms::tms_stime"][::core::mem::offset_of!(tms, tms_stime) - 8usize];
    ["Offset of field: tms::tms_cutime"][::core::mem::offset_of!(tms, tms_cutime) - 16usize];
    ["Offset of field: tms::tms_cstime"][::core::mem::offset_of!(tms, tms_cstime) - 24usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of path_t"][::core::mem::size_of::<path_t>() - 48usize];
    ["Alignment of path_t"][::core::mem::align_of::<path_t>() - 8usize];
    ["Offset of field: path_t::buffer"][::core::mem::offset_of!(path_t, buffer) - 0usize];
    ["Offset of field: path_t::device"][::core::mem::offset_of!(path_t, device) - 8usize];
    ["Offset of field: path_t::directory"][::core::mem::offset_of!(path_t, directory) - 16usize];
    ["Offset of field: path_t::filename"][::core::mem::offset_of!(path_t, filename) - 24usize];
    ["Offset of field: path_t::unixpath"][::core::mem::offset_of!(path_t, unixpath) - 32usize];
    ["Offset of field: path_t::len"][::core::mem::offset_of!(path_t, len) - 40usize];
};
#[repr(i32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of application_t"][::core::mem::size_of::<application_t>() - 72usize];
    ["Alignment of application_t"][::core::mem::align_of::<application_t>() - 8usize];
    ["Offset of field: application_t::unique_identifier"]
        [::core::mem::offset_of!(application_t, unique_identifier) - 0usize];
    ["Offset of field: application_t::name"][::core::mem::offset_of!(application_t, name) - 8usize];
    ["Offset of field: application_t::author"]
        [::core::mem::offset_of!(application_t, author) - 16usize];
    ["Offset of field: application_t::version"]
        [::core::mem::offset_of!(application_t, version) - 24usize];
    ["Offset of field: application_t::interpreter"]
        [::core::mem::offset_of!(application_t, interpreter) - 32usize];
    ["Offset of field: application_t::metadata_file"]
        [::core::mem::offset_of!(application_t, metadata_file) - 40usize];
    ["Offset of field: application_t::installed_path"]
        [::core::mem::offset_of!(application_t, installed_path) - 48usize];
    ["Offset of field: application_t::binary_path"]
        [::core::mem::offset_of!(application_t, binary_path) - 56usize];
    ["Offset of field: application_t::source"]
        [::core::mem::offset_of!(application_t, source) - 64usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of framebuffer_t"][::core::mem::size_of::<framebuffer_t>() - 24usize];
    ["Alignment of framebuffer_t"][::core::mem::align_of::<framebuffer_t>() - 8usize];
    ...
    ["Offset of field: framebuffer_t::pixels"]
        [::core::mem::offset_of!(framebuffer_t, pixels) - 16usize];
};
impl window_flag_t {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of dirent"][::core::mem::size_of::<dirent>() - 272usize];
    ["Alignment of dirent"][::core::mem::align_of::<dirent>() - 8usize];
    ["Offset of field: dirent::d_ino"][::core::mem::offset_of!(dirent, d_ino) - 0usize];
    ["Offset of field: dirent::d_type"][::core::mem::offset_of!(dirent, d_type) - 8usize];
    ["Offset of field: dirent::d_name"][::core::mem::offset_of!(dirent, d_name) - 9usize];
};
unsafe extern "C" {
...
pub struct stat {
    ...
    pub __glibc_reserved: [__uint64_t; 3usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ...
    ["Offset of field: stat::__pad0"][::core::mem::offset_of!(stat, __pad0) - 32usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of device"][::core::mem::size_of::<device>() - 56usize];
    ["Alignment of device"][::core::mem::align_of::<device>() - 8usize];
    ["Offset of field: device::type_"][::core::mem::offset_of!(device, type_) - 0usize];
    ["Offset of field: device::_open"][::core::mem::offset_of!(device, _open) - 8usize];
    ["Offset of field: device::_close"][::core::mem::offset_of!(device, _close) - 16usize];
    ["Offset of field: device::_write"][::core::mem::offset_of!(device, _write) - 24usize];
    ["Offset of field: device::_read"][::core::mem::offset_of!(device, _read) - 32usize];
    ["Offset of field: device::_lseek"][::core::mem::offset_of!(device, _lseek) - 40usize];
    ["Offset of field: device::_destroy"][::core::mem::offset_of!(device, _destroy) - 48usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of curl_slist"][::core::mem::size_of::<curl_slist>() - 16usize];
    ["Alignment of curl_slist"][::core::mem::align_of::<curl_slist>() - 8usize];
    ["Offset of field: curl_slist::data"][::core::mem::offset_of!(curl_slist, data) - 0usize];
    ["Offset of field: curl_slist::next"][::core::mem::offset_of!(curl_slist, next) - 8usize];
};
unsafe extern "C" {
